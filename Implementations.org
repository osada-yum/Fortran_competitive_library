...
#+begin_src fortran :exports code :noweb no-export
  ...
  ${type} function pop_back_${uwvec}(this, ierr)
    class(${uwvec}), intent(inout) :: this
...
#+end_src
***** at
=function at= return the element that locate at `i` of the unwrapped vector.
#+name: at-unwrapped_vector
#+begin_src fortran :exports code :noweb no-export
  !> at_${uwvec}: Return the element that locate at `i` of the ${uwvec}.
  ${type} function at_${uwvec}(this, i, ierr)
    class(${uwvec}), intent(in) :: this
    integer(int32), intent(in) :: i
    integer(int32), intent(out), optional :: ierr
  ! <<error-handling-vector-bounds-out>>
    at_${uwvec} = this%arr_(i)
    if (present(ierr)) ierr = 0
  end function at_${uwvec}
#+end_src
***** lower_bound
...
#+begin_src fortran :flags "-nocpp -g -fbacktrace -fcheck=bounds" :exports both :results output :noweb no-export :cache yes
<<unwrapped_vector-module>>
<<unwrapped_vector-test>>
#+end_src

#+RESULTS[349e84b1adcf9f5a79a08caed23f1a9d3dff55ea]: test-unwrapped_vector
