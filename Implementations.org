...
#+begin_src fortran :exports code
  ...
  ${val} function minimum_${btree}(this) result(res)
    class(${btree}), intent(in) :: this
    type(${btree_node_iter}) :: iter
...
#+begin_src fortran :exports code
  ...
  ${val} function maximum_${btree}(this) result(res)
    class(${btree}), intent(in) :: this
    type(${btree_node_iter}) :: iter
    iter%nptr_%p_ => this%root_%p_
    iter%depth_ = 1
...
#+begin_src fortran :exports code
  pure ${key} function key_${btree_node_iter}(this) result(res)
...
#+begin_src fortran :exports code
  pure ${val} function val_${btree_node_iter}(this) result(res)
    class(${btree_node_iter}), intent(in) :: this
...
#+RESULTS[bf6e1d9e87de88459b07551976ea2781f94154b5]: test-btree
