...
#+begin_src fortran :exports code
  !> ,insertion_sort_${suffix}: Sort arr in ${op} order by insertion-sort.
  !> arguments:
  !> arr: Array of ${type}.
...
#+RESULTS[82d69bd85fd6194c4f0271c049554e244abf599f]: insertion-sort-test
: 31 41 59 26 41 58
: 26 31 41 41 58 59
: 0.427 0.743 0.472 0.411 0.004 0.779
: 0.004 0.411 0.427 0.472 0.743 0.779
