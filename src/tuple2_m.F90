...
contains
  ...
  logical function less_tuple2_int32_int32(lhs, rhs) result(res)
  ...
  logical function less_equal_tuple2_int32_int32(lhs, rhs) result(res)
    type(tuple2_int32_int32), intent(in) :: lhs, rhs
    res = lhs%fst_ < rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ <= rhs%snd_
  ...
  logical function greater_tuple2_int32_int32(lhs, rhs) result(res)
    type(tuple2_int32_int32), intent(in) :: lhs, rhs
    res = lhs%fst_ > rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ > rhs%snd_
  ...
  logical function greater_equal_tuple2_int32_int32(lhs, rhs) result(res)
    type(tuple2_int32_int32), intent(in) :: lhs, rhs
    res = lhs%fst_ > rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ >= rhs%snd_
  ...
  logical function equal_tuple2_int32_int32(lhs, rhs) result(res)
    type(tuple2_int32_int32), intent(in) :: lhs, rhs
    res = lhs%fst_ == rhs%fst_ .and. lhs%snd_ == rhs%snd_
  end function equal_tuple2_int32_int32
  logical function not_equal_tuple2_int32_int32(lhs, rhs) result(res)
    type(tuple2_int32_int32), intent(in) :: lhs, rhs
  ...
  !> Compare the second elements if the first elements are same.
  logical function less_tuple2_int64_int64(lhs, rhs) result(res)
  ...
  logical function less_equal_tuple2_int64_int64(lhs, rhs) result(res)
    type(tuple2_int64_int64), intent(in) :: lhs, rhs
    res = lhs%fst_ < rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ <= rhs%snd_
  ...
  logical function greater_tuple2_int64_int64(lhs, rhs) result(res)
    type(tuple2_int64_int64), intent(in) :: lhs, rhs
    res = lhs%fst_ > rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ > rhs%snd_
  ...
  logical function greater_equal_tuple2_int64_int64(lhs, rhs) result(res)
    type(tuple2_int64_int64), intent(in) :: lhs, rhs
    res = lhs%fst_ > rhs%fst_
    if (lhs%fst_ == rhs%fst_) then
       res = lhs%snd_ >= rhs%snd_
  ...
  logical function equal_tuple2_int64_int64(lhs, rhs) result(res)
    type(tuple2_int64_int64), intent(in) :: lhs, rhs
    res = lhs%fst_ == rhs%fst_ .and. lhs%snd_ == rhs%snd_
  end function equal_tuple2_int64_int64
  logical function not_equal_tuple2_int64_int64(lhs, rhs) result(res)
    type(tuple2_int64_int64), intent(in) :: lhs, rhs
    res = lhs%fst_ /= rhs%fst_ .or. lhs%snd_ /= rhs%snd_
